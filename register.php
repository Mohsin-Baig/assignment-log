...
$email_check = "SELECT * FROM `user` WHERE email = '$user_email'";
...
if(mysqli_num_rows($query) > 0 ){
   ...
   $insert ="INSERT INTO `user` (`id`, `username`, `email`, `password`) VALUES (NULL, '$user_name', '$user_email', '$pass')";
   $insert_con = mysqli_query($connection, $insert);
   header('location:http://localhost:80/tech/login.php');
}
